...
@CucumberOptions(
        ...
        plugin = {
                "de.monochromata.cucumber.report.PrettyReports:reporting/pretty/GetStarted",
                "html:reporting/CucumberHTMLReports/GetStarted",
                "json:reporting/cucumberOtherreports/GetStarted.json",
                "junit:reporting/cucumber-reports/GetStarted.xml",
